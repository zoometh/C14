...
But few solutions exist for data vizualisation, and specially selection of radiocarbon dating by location, chronology and material life duration. Since, the idea was to create an interactive web form map-based for selection of radiocarbon data. R and Leaflet offer easy programming solutions to create such interactive maps.

## The **NeoNet** and **EUROEVOL_R** apps

There is two RShiny apps with the more or less same options. Only the dataset changes:

* [EUROEVOL_R](https://neolithic.shinyapps.io/Euroevol_R/) is based on the [EUROEVOL database](http://discovery.ucl.ac.uk/1469811/) and covers the Central, Western and Northern Europe from Paleolithic times to the end of Bronze Age (ca. 17,000 - 500 BC)
![](https://raw.githubusercontent.com/zoometh/C14/main/docs/imgs/app_euroevol_thumbnail.png){width=100%}
* [NeoNet](https://neolithic.shinyapps.io/NeoNet/) is the based on a Google Sheet and covers the Central Mediterranean for the Late Mesolithic and Middle Neolithic (ca. 8,000 - 4,500 BC). The database is still at the development stage.
![](https://raw.githubusercontent.com/zoometh/C14/main/docs/imgs/app_neonet_thumbnail.png){width=100%}


## Tutorial
For this tutorial, we will choose the [NeoNet](https://neolithic.shinyapps.io/NeoNet/) app.

![](https://raw.githubusercontent.com/zoometh/C14/main/docs/imgs/app_neonet.png){width=100%}
...
The panel **map** is used for Radiocarbon Dating by Location, Chronology and Material Life Duration.
...
* The top-center radio button **c14 group by...** (<span style="color:red">red</span> box) allows to plot datations:
