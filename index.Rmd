...
Beside [Bchron](https://cran.r-project.org/web/packages/Bchron/vignettes/Bchron.html), other R packages allows calibration and management of radiocarbon dates like: 
...
* [ArchaeoPhases](https://cran.r-project.org/web/packages/ArchaeoPhases/index.html). 

  
The main dedicated apps for calibration are: [OxCal](https://c14.arch.ox.ac.uk/oxcal/), [CalPal](http://www.calpal-online.de/) and [Calib](http://calib.org/calib/), [BCal](https://bcal.shef.ac.uk/)
