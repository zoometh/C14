...
Today exists a lot of web-based ressources to manage radiocarbon dates, but few solutions exist for their **interactive selection and spatialization**. NeoNet app and EUROEVOL_R app have been developped for this purpose. These interactive web form map-based allow the selection of radiocarbon dates by: 
...
c14.app.url <- c("https://theia.arch.cam.ac.uk/MedAfriCarbon/", "https://github.com/ropensci/c14bazAAR/blob/main/README.md", "https://www.ibercrono.org/goget/index.php", "https://github.com/ISAAKiel/oxcAAR/blob/main/README.md")
