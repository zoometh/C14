...
The **NeoNet** app is a RShiny based application for the selection of radiocarbon dating by location, chronology and material life duration. It allows to subset the radiocarbon dataset by: 

* geographical region of interest (ROI)
* time span between a *tpq* and a *taq* in cal BC
* period
* type of material life duration (short like, long life or others)
* maximum standard deviation threshold (SD)

After a short presentation of the [**NeoNet project**][], we will see [How to use the **NeoNet app**][] and [How to participate to the **NeoNet database**][] 

## **NeoNet project**

The **[NeoNet project](https://www.imf.csic.es/index.php/actualidad/actividades/actividades-2020/1224-seminario-neonet-origen-desarrollo-y-consolidacion-del-neolitico-en-el-ambito-mediterraneo)**, conducted by [Juan Gibaja](https://orcid.org/0000-0002-0830-3570) and [Miriam Cubas](https://orcid.org/0000-0002-2386-8473), aims to investigate the origin, the spread and the consolidation of the farming way-of-life in Mediterranean.
...
* [**map** panel][]: geographical region of interest with different possibilities to subset the datings dataset
* [**calib** panel][]: calibration on-the-fly of the selected datings
...
The Google Sheet (ie, the database) is composed by three spreadsheets  
...
Thanks to the facilities offer by the app, we expect to conduct collaborative spatio-temporal analysis. At the short and middle term we want to conform the app and the database to the [FAIR principles](https://www.go-fair.org/fair-principles/) of Open Science, and we also want to publish scientific papers. Do do so, every C14 dating should be carefully referenced and license and auhorship should be clear.
