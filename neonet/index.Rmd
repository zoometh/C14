...
df.bib <- data.frame(tpq = c("-6086","..."),
                     ...
                     select = c("VRAI","..."),
                     RedNeo = c("1","..."),
                     bib = c("Binder D,. et al. Modelling the earliest ...",
                             "..."),
                     bib_url = c("<b>Binder18</b>","..."),
                     stringsAsFactors = F)
...
The BibTex references are recorded [here](https://drive.google.com/file/d/1ZmbddwV7iqHUut1e_FNRa9_qogvHkSTj/view?usp=sharing). If you use Google, the default *Text Editor* app can open the file.
