...
We will see [How to use the **NeoNet app**][], [How to use the **NeoNet database**][] and [How to participate][]
...
#### retrieve coordinates of an archaeological site

The geographical map, OpenStreetMap, offers a well documented basemap. Archaeological sites are sometimes already mapped, like the Ligurian sites of Arene Candide and Grotta della Pollera. Clicking on the map show the lat/long coordinates of the current point (<span style="color:red"><b>red</b></span> box under the tpq/tap slider). These coordinates can then be copied and used to modify the NeoNet database. 
...
## How to use the **NeoNet database**

The **NeoNet database** is a collaborative online Google Sheet. The database is composed by 3 spreadsheets  
...
* publish scientific papers both for the archaeological results and for the app
* in accordance with the [**FAIR** principles](https://www.go-fair.org/fair-principles/) (*Findable*, *Accessible*, *Interoperable* & *Reusable*) of the Open Science, publish as open-source data the **NeoNet app** source code and the radiocarbon dataset 
