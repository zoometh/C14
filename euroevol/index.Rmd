---
title: "RShiny C14 dating interactive map: the **NeoNet** app"
...
The current database is a simple online Google Sheet accessible by contacting the authors (<thomashuet7@gmail.com >, <nicco.mazzucco@gmail.com >).

### NeoNet spreadsheets

The database is composed by three spreadsheets
![](https://raw.githubusercontent.com/zoometh/C14/main/docs/imgs/app_neonet_db_onglets.png){width=20%}
...
The others fields only concern the [EUROEVOL_R](https://neolithic.shinyapps.io/Euroevol_R/), [EUROEVOL_R](https://zoometh.github.io/C14)
