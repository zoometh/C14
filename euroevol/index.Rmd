---
title: "**EUROEVOL_R app**, mapping radiocarbon dating from the EUROEVOL database"
author: "Thomas Huet"
# date: "11/12/2020"
header-includes:
  - \usepackage{float}
...
The [**EUROEVOL_R app**](https://neolithic.shinyapps.io/Euroevol_R/) is an interactive web application based on the radiocarbon **[EUROEVOL database](#db)**. It allows the selection of radiocarbon dating by location, chronology and material life duration by subsetting a radiocarbon dataset according to: 
...
**EUROEVOL_R app** has a different dataset from the **[NeoNet app](https://neolithic.shinyapps.io/NeoNet/)**  but the same functionalities (ie, same RShiny script). So, to learn how to use these two apps, visit the [**NeoNet app** webpage](https://zoometh.github.io/C14/neonet/#app).  
